...
public class LoginRegisterPanel {
	...
	public void popupLogin(Panel panel) {
		...
		btnlogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent arg0) {
				...
				serverConnection.login(userField.getText(),
	...
	public void popupRegister(Panel panel) {
		...
		btnlogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent arg0) {
				Thread thread = new Thread(serverConnection);
				if (passwortField.getPassword().equals(passwort2Field)) {
					serverConnection.register(userField.getText(),
							passwortField.getPassword(), mailField.getText());
				}
				thread.start();
			}
		});
